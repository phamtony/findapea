...
<head>
	...
	<title>Findapea - Home Page</title>
...
<body>
	...
	<main>
		<div class="findapea-index-home">
			<div class="findapea-index-home-container">
				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="findapea-index-hero">
							<div class="findapea-index-hero-container">

								<!-- Image Background -->
								<div class="image-bg">
									<div class="image-bg-container">
										<img src="/img/hero copy.jpg" alt="">
									</div>
								</div>

								<!-- Home Header -->
								<div class="index-header">
									<div class="index-header-container cs-md-sub-fullpage-pad cs-fullpage-pad cs-both-sub-seperation clearfix">
										
										<div class="index-header-left-side pull-xs-left">
											<div class="index-header-left-side-container">
												<h2>Findapea</h2>
											</div>
										</div>

										<div class="index-header-right-side pull-xs-right">
											<div class="index-header-right-side-container">
												<i class="fa fa-bars hidden-md-up" aria-hidden="true"></i>
												<ul class="list-unstyled clearfix hidden-sm-down">
